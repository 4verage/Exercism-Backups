...
def check_drinks(drink_name, drink_ingredients):
    ...
    """
    return drink_name + " Cocktail" if not set(drink_ingredients).isdisjoint(ALCOHOLS) else drink_name + " Mocktail"
...
def singleton_ingredients(dishes, intersection):
    ...
    for recipe in dishes:
        singletons = singletons.union(recipe.difference(intersection))
